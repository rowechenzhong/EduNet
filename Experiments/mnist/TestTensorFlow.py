...
# from_tensor_slices works like zip(), and batch() makes... batches.
...
for construct in (baseline_model,):
    ...
    # Fit the model
    model.fit(x_train1d, y_train, validation_data=(
        x_test1d, y_test), epochs=50, batch_size=1000, verbose=2)
